...
async function testBirdeyeTokenList() {
  try {
    const response = await axios.get(`${BIRDEYE_API_URL}/v1/token/list?sort_by=created_timestamp&sort_type=desc&offset=0&limit=50`, {
      headers: {
